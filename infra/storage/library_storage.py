...
class LibraryStorage:
    """
    Manages the library catalog (library.json) and coordinates BookStorage instances.

    Provides library-wide operations:
    - Catalog management (add/remove books, track scans)
    ...
    def get_book_storage(self, scan_id: str):
        ...
        Example:
            ...
            >>> storage = library.get_book_storage("modest-lovelace")
