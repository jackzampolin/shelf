    ...
    def process_book(self, book_title, resume=False):
        ...
        try:
            ...
            on_event = progress.create_llm_event_handler(
                ...
                checkpoint=storage.correction.checkpoint if self.enable_checkpoints else None
            )
            ...
            if errors == 0:
                ...
                metrics_summary = storage.correction.checkpoint.get_metrics_summary() if self.enable_checkpoints else None
