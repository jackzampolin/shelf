"""
Phase 5: Rich progress display for ToC assembly.

Shows real-time feedback during LLM-based ToC entry assembly.
"""
...
class TocAssemblyProgress:
    """
    Live progress display for ToC assembly.

    Shows:
    - Current page being assembled
    ...
    def _render(self, current_status: str):
        ...
        # Progress summary
        summary = Text()
        summary.append(f"Phase 5: Assembling ToC ", style="bold blue")
