"""
Label-Pages Stage Storage Operations

Handles all file I/O for the label-pages stage:
- Loading OCR inputs and source images
- Saving labeled outputs
...
class LabelPagesStageStorage:
    """Storage operations for label-pages stage."""
    ...
    def list_completed_pages(self, storage: BookStorage) -> List[int]:
        ...
        Completed pages have labeled output files on disk.
    ...
    def save_labeled_page(
        ...
        """
        Save labeled page output with metrics.
        ...
        Args:
            storage: BookStorage instance
            page_num: Page number (1-indexed)
            data: Labeled page data (validated against schema)
